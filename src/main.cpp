...
int main(int argc, char* argv[]) {
	...
	airport_network.AddNonDirectionalEdge(0, 1, 160.0);
	airport_network.AddNonDirectionalEdge(0, 2, 220.0);
	airport_network.AddNonDirectionalEdge(0, 3, 640.0);

	double dist_sce_ord = 0.0;
	if (airport_network.FindEdgeBetweenNodes(3, 0, dist_sce_ord)) {
